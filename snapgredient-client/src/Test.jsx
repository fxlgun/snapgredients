...
export default function News({ query }) {
  const [newsData, setNewsData] = useState([
    ...
    },
    {
      ...
      author: null,
      title:
        "Fed's Williams says Fed needs more rate rises to cool inflation - Reuters.com",
      description:
    ...
    },
    {
      ...
      author: null,
      title:
        "'Joe Cool' delivers as Bengals plow Bills to reach AFC ... - Reuters",
      description:
          ...
          {newsData?.map((news, idx) => (
            <div className={styles.news} key={idx}>
              ...
              <a href={news.url} target="_blank">
                Check out <FontAwesomeIcon icon={faArrowUpRightFromSquare} />
              </a>
            </div>
          ))}
        </div>
